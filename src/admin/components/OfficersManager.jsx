...
const CAT = {
  ...
  'SUB - STATION COMMANDER': { color:'#ff6b4a', light:'rgba(255,107,74,0.08)',  border:'rgba(255,107,74,0.22)', dot:'#ff6b4a', label:'Sub - Station Commander', desc:'Sub - Station Commander',    short:'CMD'  },
